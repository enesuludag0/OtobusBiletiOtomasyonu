...
{
    public partial class Yolcu4 : Form
    {
        ...
        private void bttnFiyat_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string kaydetSorgu = "INSERT INTO biletler (turizm,pnr_no,kalkis,varis,tarih,saat,tahmini_sure,yolcu1,yolcu2,yolcu3,yolcu4,koltuk_no1,koltuk_no2,koltuk_no3,koltuk_no4,alinan_koltuk_sayisi,fiyat) " +
                "VALUES (@turizm,@pnr_no,@kalkis,@varis,@tarih,@saat,@tahmini_sure,@yolcu1,@yolcu2,@yolcu3,@yolcu4,@koltuk_no1,@koltuk_no2,@koltuk_no3,@koltuk_no4,@alinan_koltuk_sayisi,@fiyat)";
            ...
            cmd.Parameters.AddWithValue("@yolcu3", textBoxAdSoyad3.Text);
            cmd.Parameters.AddWithValue("@yolcu4", textBoxAdSoyad4.Text);
            cmd.Parameters.AddWithValue("@koltuk_no1", lblKoltukNo1.Text);
            cmd.Parameters.AddWithValue("@koltuk_no2", lblKoltukNo2.Text);
            cmd.Parameters.AddWithValue("@koltuk_no3", lblKoltukNo3.Text);
            cmd.Parameters.AddWithValue("@koltuk_no4", lblKoltukNo4.Text);
