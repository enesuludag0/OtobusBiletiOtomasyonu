...
{
    public partial class Yolcu3 : Form
    {
        ...
        private void bttnFiyat_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string kaydetSorgu = "INSERT INTO biletler (turizm,pnr_no,kalkis,varis,tarih,saat,tahmini_sure,yolcu1,yolcu2,yolcu3,koltuk_no1,koltuk_no2,koltuk_no3,alinan_koltuk_sayisi,fiyat) " +
                "VALUES (@turizm,@pnr_no,@kalkis,@varis,@tarih,@saat,@tahmini_sure,@yolcu1,@yolcu2,@yolcu3,@koltuk_no1,@koltuk_no2,@koltuk_no3,@alinan_koltuk_sayisi,@fiyat)";
