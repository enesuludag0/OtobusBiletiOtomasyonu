...
{
    public partial class Yolcu1 : Form
    {
        ...
        private void bttnFiyat_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string kaydetSorgu = "INSERT INTO biletler (turizm,pnr_no,kalkis,varis,tarih,saat,tahmini_sure,yolcu1,koltuk_no1,alinan_koltuk_sayisi,fiyat) " +
                "VALUES (@turizm,@pnr_no,@kalkis,@varis,@tarih,@saat,@tahmini_sure,@yolcu1,@koltuk_no1,@alinan_koltuk_sayisi,@fiyat)";
            ...
            cmd.Parameters.AddWithValue("@alinan_koltuk_sayisi", KoltukSecim.secilenKoltukSayisi.ToString());
